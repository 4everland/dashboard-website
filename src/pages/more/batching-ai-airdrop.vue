          ...
          <div class="pa-6 task-desc flex-1 h-flex space-btw">
            <div>
              ...
              <div class="fz-14 mt-4">
                ...
                in our exclusive giveaway. Only 100 lucky winners will take home
            ...
            <div class="link-btn">
              <v-btn
                ...
                color="#fff"
                target="blank"
                href="https://app.galxe.com/quest/4EVERLAND/GCKdetkwbs"
              >
  ...
  methods: {
    ...
    async getBitgetInfo() {
      try {
        ...
        const { data } = await fetchTaskStatus(6678);
