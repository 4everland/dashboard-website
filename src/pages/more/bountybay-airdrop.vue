      ...
      <div class="bitget-body">
        ...
        <div class="task-item d-flex mb-10">
          <div class="pa-6 task-img-wrap al-c">
            <img src="/img/airDrop/bountyBay-airdrop.png" width="100%" alt="" />
          </div>
          <div class="pa-6 task-desc flex-1 h-flex space-btw">
            ...
            <div class="link-btn">
              <v-btn
                ...
                color="#fff"
                target="blank"
                href="https://t.me/bountybay_bot/deals?startapp=campaign_recGjT1wPikWAC7sM"
              >
  ...
  methods: {
    ...
    async getBitgetInfo() {
      try {
        ...
        const { data } = await fetchTaskStatus(6677);
