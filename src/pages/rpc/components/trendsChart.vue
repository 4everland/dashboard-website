...
import { fetchTrends } from "@/api/rpc.js";
      ...
      const option = {
        ...
        xAxis: {
          ...
          axisLabel: {
            formatter: function (value) {
              if (_this.chartParams.days == 30) {
                return _this.formatterTime(value, "{m}-{d}");
              } else {
                return _this.formatterTime(value, "{h}:{i}");
              }
            },
          },
        },
        ...
        tooltip: {
          ...
          formatter: function (params, ticket, callback) {
            ...
            let timeFliter = _this.formatterTime(time);
